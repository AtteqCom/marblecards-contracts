...
contract MarbleCoinMatic is ERC20, Ownable, AdministratorRole, ERC20Detailed, ERC20Burnable {
    ...
    constructor (address _childChainManagerProxy) public ERC20Detailed("MarbleCoin", "MBC", 18) {
        childChainManagerProxy = _childChainManagerProxy;
    }

    // being proxified smart contract, most probably childChainManagerProxy contract's address
    // is not going to change ever, but still, lets keep it 
    function updateChildChainManager(address newChildChainManagerProxy) external onlyAdministratorOrOwner {
    ...
    function addAdministrator(address account) public onlyAdministratorOrOwner {
        _addAdministrator(account);
    }

    // Allow Administrator or Owner to remove an Administrator
    function removeAdministrator(address account) public onlyAdministratorOrOwner {
    ...
    function freezeMint() public onlyAdministratorOrOwner returns (bool) {
        _supplycapped = true;
